  ...
  columns: [
    {
      name: 'channel_type',
      type: 'string',
      description: 'Channel adapter type of the dropped message.',
    },
    {
      name: 'platform_id',
      type: 'string',
      description: 'Platform chat ID where the message was dropped.',
    },
    {
      name: 'user_id',
      type: 'string',
      description: 'Sender user ID if resolved, null otherwise.',
    },
    {
      name: 'sender_name',
      type: 'string',
    ...
    },
    {
      ...
      type: 'string',
      description: 'Messaging group ID if resolved.',
    },
    {
      name: 'agent_group_id',
      type: 'string',
      description: 'Target agent group ID if resolved.',
    },
    {
      name: 'message_count',
      type: 'number',
      description: 'Number of dropped messages from this sender on this chat.',
    },
    {
      name: 'first_seen',
      type: 'string',
      description: 'First drop timestamp.',
    },
    {
      name: 'last_seen',
      type: 'string',
      description: 'Most recent drop timestamp.',
    },
  ],
